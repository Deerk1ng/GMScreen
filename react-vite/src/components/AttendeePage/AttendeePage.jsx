...
import { get_attendee_thunk } from '../../redux/attendees'
                ...
                <div className="attendance-container">
                    ...
                    <div>
                        ...
                        {events[key]['attendees'][user.id]['status'] == 'Owner' ?
                                ...
                                className='button'
                                modalComponent={<UpdateAttendeeModal  event_id={key} attendee_id={events[key]['attendees'][user.id]['id']} curr_status={events[key]['attendees'][user.id]['status'].toLowerCase()} user={user} att={true}/>}
                                />
                        }
                    </div>
                        : <></>
