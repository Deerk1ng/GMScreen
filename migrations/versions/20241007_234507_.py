...
def upgrade():
    ...
    sa.Column('backstory', sa.Text(length=300), nullable=False),
    sa.Column('personality', sa.Text(length=300), nullable=False),
    sa.Column('appearance', sa.Text(length=300), nullable=False),
