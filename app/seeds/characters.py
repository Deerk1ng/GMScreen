...
def seed_characters():
    characters = {
        "Camilla Hect" : {"user_id": 1, "level": 1, "strength": 8, "dexterity": 10, "constitution": 12, "intelligence": 13, "wisdom": 14, "charisma": 15, "character_class": 'rogue', "subclass": "Assassin", "race": "Human", "backstory": "Camila is the knight devoted to her childhood friend and distant cousin, Palamedes. Palamedes is currently missing and her mission is to find and save him", "personality": "Devoted, Intelligent, Slightyly Gullible", "appearance": "Tall, Strong features, long black hair, purple eyes, shining almost new clothing", "feats": "none", "equipment": "medium armor,rapier,shattered human skull", "abilities": "Expertise,Sneak Attack,Thieves' Cant", "spells": "none"},
